    ...
    <section className="relative bg-white pt-20 pb-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[650px] transform scale-[0.85] lg:scale-[0.8] origin-center lg:origin-right">
            {/* Top-Right Abstract Shape (Dark Blue + Orange curve) */}
            <div className="absolute -top-12 right-[10%] w-24 h-24 z-0 transform rotate-[15deg]">
            ...
            <div className="absolute -left-4 sm:-left-12 top-[15%] w-24 h-40 z-0">
            ...
            <div 
              className="absolute left-6 sm:left-12 top-0 w-[75%] h-[80%] z-10 bg-gray-200"
            ...
            >
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#e5e7eb] opacity-80" style={{ clipPath: 'polygon(100% 0, 0 0, 100% 100%)' }}></div>
              {/* Decorative orange triangle overlay at bottom right */}
              <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#c9a84c]" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 100%)' }}></div>
            </div>

            {/* Chevron Overlays */}
            <div className="absolute right-[12%] top-[40%] w-20 h-16 z-20">
            ...
            <div className="absolute right-0 bottom-4 w-[55%] aspect-[4/5] sm:aspect-square bg-white p-3 sm:p-4 shadow-2xl z-30">
